...
When an incident does occur, it is important to report it promptly. To report a possible violation, email [haseebahmed6621@gmail.com](mailto:haseebahmed6621@gmail.com) privately. Do not post conduct reports or sensitive personal details in public issues, pull requests, or discussions. Include a description of what happened and relevant links or dates where available, sharing only information needed to understand the report.

GuardStep's founding maintainer, Haseeb Ahmed ([@haseebahmed248](https://github.com/haseebahmed248)), is currently responsible for receiving reports, investigating incidents, and enforcing this policy. In this document, **Community Moderators** refers to the founding maintainer. Any future change in reporting or enforcement responsibility will be documented here.
...
For GuardStep, community spaces include this repository's issues, pull requests, discussions, and any other official project channels.

## Attribution

This Code of Conduct is adapted from the [Contributor Covenant, version 3.0](https://www.contributor-covenant.org/version/3/0/).

Contributor Covenant is stewarded by the Organization for Ethical Source and licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). This document, including the GuardStep adaptations, is distributed under the same license. The adaptations identify the reporting contact and responsible maintainer, clarify private reporting and project spaces, use Community Moderators consistently, and adjust formatting. GuardStep's software license remains Apache License 2.0.

For answers to common questions about Contributor Covenant, see the [FAQ](https://www.contributor-covenant.org/faq). [Translations](https://www.contributor-covenant.org/translations) and additional [enforcement and community guideline resources](https://www.contributor-covenant.org/resources) are available. The enforcement ladder was inspired by the work of [Mozilla's code of conduct team](https://github.com/mozilla/inclusion).
