...
The adapter attempts to cancel oversized response bodies even when `Content-Length` allows rejecting them before reading. This early rejection does not wait for cancellation to complete.
